 ...
 * 2. `[writable]` car: {@link CarMetadata} 
...
export const mint = (args: MintArgs): TransactionInstruction => {
    ...
    const [carPubkey] = pda.deriveCarMetadataPDA({
        mint: args.mint,
    }, _programId);
    ...
    return new TransactionInstruction({
        ...
        keys: [
            ...
            {pubkey: carPubkey, isSigner: false, isWritable: true},
...
export const getCarMetadata = async (
    ...
    return T.decodeCarMetadata(deserialize(T.CarMetadataSchema, buffer.data) as Record<string, unknown>);
}
