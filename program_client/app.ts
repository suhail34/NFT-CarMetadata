...
async function main(feePayer: Keypair) {
    ...
    /**
     * Derive the Car Metadata so we can retrieve it later
     */
    const [gemPub] = deriveCarMetadataPDA(
        {
            mint: mint.publicKey,
        },
        progId,
    );
    console.info("+==== Car Metadata Address ====+");
     ...
     */
    let gem = await getCarMetadata(gemPub);
    console.info("+==== Car Metadata ====+");
    console.info(gem);
     ...
     * Get the Gem Metadata
     */
    gem = await getCarMetadata(gemPub);
    console.info("+==== Car Metadata ====+");
    console.info(gem);
